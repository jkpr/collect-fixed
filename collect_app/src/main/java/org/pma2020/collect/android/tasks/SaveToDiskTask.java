...
import org.pma2020.collect.android.exception.EncryptionException;
...
import org.pma2020.collect.android.utilities.EncryptionUtils;
import org.pma2020.collect.android.utilities.EncryptionUtils.EncryptedFormInformation;
...
public class SaveToDiskTask extends AsyncTask<Void, String, SaveResult> {
    ...
    /**
     * Writes the data to the sdcard, and updates the instances content provider.

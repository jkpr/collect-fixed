...
import org.pma2020.collect.android.activities.GeoPointActivity;
import org.pma2020.collect.android.activities.GeoPointMapActivity;
import org.pma2020.collect.android.activities.GeoPointMapNotDraggableActivity;
...
public class GeoPointWidget extends QuestionWidget implements IBinaryWidget {
	...
	public GeoPointWidget(Context context, FormEntryPrompt prompt) {
      ...
      mUseMaps = CompatibilityUtils.useMapsV2(context);
		...
		mViewButton.setId(ViewIds.generateViewId());
		mViewButton.setText(getContext().getString(R.string.show_location));
		mViewButton.setTextSize(TypedValue.COMPLEX_UNIT_DIP, getAnswerFontSize());
		...
		mGetLocationButton.setId(ViewIds.generateViewId());
